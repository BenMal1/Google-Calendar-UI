...
import { CreateEventModal, NewEventState } from "./components/CreateEventModal"
...
export default function Home() {
  ...
  const [initialEventDataForModal, setInitialEventDataForModal] = useState<Partial<NewEventState>>({});
          ...
          >
            ...
            >
              <div className="p-6">
                ...
                {/* Settings Modal - Refactored into its own component */}
        <SettingsModal
          ...
          setAllDayEventDisplay={setAllDayEventDisplay}
